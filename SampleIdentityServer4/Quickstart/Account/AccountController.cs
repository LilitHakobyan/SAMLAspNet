...
namespace SampleIdentityServer4.Quickstart.UI
{
    /// <summary>
    ...
    public class AccountController : Controller
    {
        ...
        /// </summary>
        [HttpGet]
      //  [Route("Saml2/ExternalLoginCallback")]
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var returnUrl1 = result.Properties.Items["returnUrl"];
            if (_interaction.IsValidReturnUrl(returnUrl1) || Url.IsLocalUrl(returnUrl1))
            {
